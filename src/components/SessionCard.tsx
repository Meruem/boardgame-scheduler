...
export default function SessionCard({ session, onUpdate, locale, readOnly = false }: SessionCardProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
      ...
      {/* Comments Section */}
      <Comments sessionId={session.id} locale={locale} readOnly={readOnly} />
